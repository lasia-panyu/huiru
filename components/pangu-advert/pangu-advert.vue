		 ...
		 :style="{
			...
			<swiper-item class="u-swiper-item" v-for="(item, index) in list" :key="index">
				<view class="u-list-image-wrap" @tap.stop.prevent="listClick(index)" :class="[uCurrent != index ? 'u-list-scale' : '']" :style="{
					...
					<image class="u-swiper-image" :src="item[name] || item" mode="scaleToFill"></image>
	...
	export default {
		props: {
			...
			list: {
				...
				default () {
					return [
						{image: '../../static/image/ad1.jpg', title: '1'},
						{image: '../../static/image/ad2.jpg', title: '2'},
						{image: '../../static/image/ad3.jpg', title: '3'},
						{image: '../../static/image/ad4.jpg', title: '4'},
						{image: '../../static/image/ad5.jpg', title: '5'},
					];
				}
			},
			// 是否显示title标题
